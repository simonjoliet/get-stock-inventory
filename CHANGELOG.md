...
- Renamed project from `get-stock-inventory` to `stock-inventory-tools`
...
## v1.0 - 2026-04-05
- Initial commit, merging of prior project started in 2024 into a single branch:
  - get-stock
  - adobe-stock-get-portfolio
